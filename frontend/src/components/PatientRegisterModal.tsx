          ...
          {currentStep === 1 ? (
            <>
              ...
              <button
                ...
                disabled={!name.trim() || !age || !address.trim()}
                className="flex-1 px-4 py-2 bg-gradient-to-br from-green-gradient-dark to-green-gradient-light text-white rounded-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90"
              >
                Next
              </button>
            </>
