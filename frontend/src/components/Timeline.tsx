...
const EVENT_TYPES: TimelineEventType[] = ['symptom', 'appointment', 'medication', 'alert', 'chat'];
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-slate-200">
      ...
      <div className="px-6 py-4 border-b border-slate-200">
        <h2 className="text-lg font-semibold text-slate-800 mb-3">Health Timeline</h2>
              ...
              {sortedEvents.map((event) => (
                <div key={event.id} className="relative pl-10">
                  ...
                  <div className={cn(
                    ...
                    event.type === 'alert' ? 'border-red-200 bg-red-50' : 'border-slate-200 bg-slate-50'
                  )}>
